    ...
    export default {
        ...
        data() {
            const tableColumns = [
                ...
                {
                    field: 'certInfo.categoryName',
                    text: this.$t('证书类别'),
                    minWidth: 120
                },
                {
                    field: 'certInfo.certOrg',
                    text: this.$t('发证机构'),
                    minWidth: 110
                },
                {
        ...
        methods: {
            ...
            downloadSelect() {
                ...
                const url = `${
                    process.env.CERT_API
                }/certUserRel/downloadCertUser${formatGetParams(params)}&userId=${
            ...
            downloadPdf(idList) {
                ...
                const url = `${
                    process.env.CERT_API
                }/certUserRel/downloadPdf${formatGetParams(params)}&userId=${
                    this.listQuery.userId
                }&_token=${this.token}`;
                window.open(url);
            },
