...
<template>
    <div class="qnt__radio">
        ...
        <draggable
            tag="ul"
            class="qnt__radio__optionList"
            :option-list="val.optionList"
            handle=".qnt__item__sort"
            v-bind="dragOptions"
        >
            <li v-for="(item, idx) in val.optionList" :key="idx" class="qnt__radio__item">
...
<script>
    ...
    export default {
        ...
        methods: {
            addItem() {
                this.val.optionList.push(deepClone(this.radioTemp));
            },
            remove(index) {
                this.val.optionList.splice(index, 1);
            },
            selectTitleImg() {
            ...
            removeAnswerImg(index, idx) {
                this.val.optionList[index].imgUrls.splice(idx, 1);
            }
        }
    };
</script>
