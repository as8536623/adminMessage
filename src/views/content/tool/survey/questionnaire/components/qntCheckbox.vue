...
<template>
    <div class="qnt__checkbox">
        ...
        <draggable
            tag="ul"
            class="qnt__checkbox__itemList"
            :item-list="val.itemList"
            handle=".qnt__item__sort"
            v-bind="dragOptions"
        >
            <li v-for="(item, idx) in val.itemList" :key="idx" class="qnt__checkbox__item">
...
<script>
    ...
    export default {
        ...
        methods: {
            addItem() {
                this.val.itemList.push(deepClone(this.checkboxTemp));
            },
            remove(index) {
