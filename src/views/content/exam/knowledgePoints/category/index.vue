...
<template>
    <article class="app-container warehouse__category">
        <qgu-tree :datalist="treeData" :default-expand-all="defaultExpandAll" :show-include-child="false">
            <span slot-scope="{ node, data }" class="custom-tree-node">
                ...
                <span class="tree__option">
                    <el-tooltip
                        v-if="checkPermission('addPointCategory')"
                        class="item"
                        effect="dark"
                        :content="$t('新增类别')"
                        placement="top"
                    ...
                    <el-tooltip
                        v-if="checkPermission('updPointCategory')"
                        class="item"
                        effect="dark"
                        :content="$t('编辑')"
                        placement="top"
                    ...
                    <el-tooltip
                        v-if="checkPermission('delPointCategory')"
                        class="item"
                        effect="dark"
                        :content="$t('删除')"
                        placement="top"
                    ...
                    <el-tooltip
                        v-if="checkPermission('movePointCategory')"
                        class="item"
                        effect="dark"
                        :content="$t('上移')"
                        placement="top"
        ...
        <el-dialog
            v-if="dialogVisible"
            append-to-body
            :title="$t(editQuery.id ? '知识点类别-编辑' : '知识点类别-新增')"
...
<script>
    ...
    import {
        ...
        deleteNode,
        moveNode
    } from '@/api/exam/item/itemBankCategory';
