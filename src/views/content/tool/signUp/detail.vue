    ...
    <article class="app-container tool-edit-container">
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane :label="$t('基本信息')" name="first">
                <basic-info :data="data" :source="source" @editHandle="editBack"/>
            </el-tab-pane>
            <el-tab-pane :label="$t('报名设置')" name="second">
                <setting :data="data" :source="source" @editHandle="editBack"/>
            </el-tab-pane>
            <el-tab-pane :label="$t('参与人员')" name="third">
                <participants :id="id" :data="data" :source="source" @editHandle="editBack"/>
            </el-tab-pane>
        </el-tabs>
    </article>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                source: this.$route.query.source || 'enroll',
                data: {}
            };
        },
        created() {
