...
<template>
    <article class="marked__paper__container">
        <el-form
            :model="listQuery"
            :inline="true"
...
<script>
    import {getMarked} from '@/api/exam/exam/judge';
                ...
                },
                {
                    ...
                    render: (h, param) => {
                        ...
                        const detailBtn = h('QguButton', {
                            ...
                            on: {
                                click: () => {
                                    this.$router.push({name: 'judgeDetail', query: {id: param.row.id}});
                                }
                            }
                        });
